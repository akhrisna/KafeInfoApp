{literal}
	...
	<script type="text/javascript"> 
		...
		// var
		var newsuserid = "{/literal}{$newsdetails.user_id}{literal}";
		var _notifscreenshot = "{/literal}{#removescreenshot#}{literal}";
		...
		function show_error(id) 
		{
			...
			var fieldempty = "{/literal}{#fieldempty#}{literal}";
		...
		function show_notification_global(action)
		{
			...
			// check the action
			 ...
			 {
				// assign text			 	
			 	var big_text = '{/literal}{#duplicatefound#}{literal}';
			 	var small_text = '{/literal}{#tryagain#}{literal}';
			 ...
			 {
			 	// assign text
			 	var big_text = '{/literal}{#newsupdated#}{literal}';
			 	var small_text = '{/literal}{#redirecttodashboard#}{literal}';
			 ...
			 {
			 	// assign text
			 	var big_text = '{/literal}{#somethingiswrong#}{literal}';
			 	var small_text = '{/literal}{#tryagain#}{literal}';
