<?php /* Smarty version 2.6.9, created on 2010-06-11 10:51:20
         compiled from datagrid/news.grid.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'datagrid/news.grid.tpl', 16, false),array('modifier', 'truncate', 'datagrid/news.grid.tpl', 16, false),)), $this); ?>
<!-- news list -->
...
">
					...
					<div class="news_vote_up float_left" id="link_bar_up_<?php echo $this->_tpl_vars['news_list'][$this->_sections['list']['index']]['id']; ?>
...
"><?php echo $this->_config[0]['vars']['voteup']; ?>
					...
					<div class="news_vote_down float_left" id="link_bar_down_<?php echo $this->_tpl_vars['news_list'][$this->_sections['list']['index']]['id']; ?>
