<?php /* Smarty version 2.6.9, created on 2009-06-20 19:03:06
         compiled from includes/newslogin.inc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'includes/newslogin.inc.tpl', 20, false),)), $this); ?>
<!-- the header -->
...
' class="action_icon"/></a>
	...
	<?php endfor; else: ?>
		<div class="comment_empty">
			<div class="comments_single_padding">
				<h3><?php echo $this->_config[0]['vars']['nopostnews']; ?>
</h3>
			</div>
		</div>
	<?php endif; ?>
