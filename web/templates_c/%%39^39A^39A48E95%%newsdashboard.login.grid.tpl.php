<?php /* Smarty version 2.6.9, created on 2009-06-22 14:04:44
         compiled from datagrid/newsdashboard.login.grid.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'datagrid/newsdashboard.login.grid.tpl', 5, false),)), $this); ?>
...
'">
			...
			<div class="comment_header_action">
				<a href="javascript:delete_news('<?php echo $this->_tpl_vars['news'][$this->_sections['mysec']['index']]['id']; ?>
');" title='<?php echo $this->_config[0]['vars']['deletenews']; ?>
'><img src='images/ic_delete.png' alt='<?php echo $this->_config[0]['vars']['deletenews']; ?>
' class="action_icon"/></a>
				<a href="edit.php?id=<?php echo $this->_tpl_vars['news'][$this->_sections['mysec']['index']]['id']; ?>
" title='<?php echo $this->_config[0]['vars']['editnews']; ?>
'><img src='images/ic_edit.png' alt='<?php echo $this->_config[0]['vars']['editnews']; ?>
' class="action_icon"/></a>
			</div>
		</div>
	</div>
