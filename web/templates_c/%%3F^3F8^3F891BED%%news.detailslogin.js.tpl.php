<?php /* Smarty version 2.6.9, created on 2009-06-20 18:47:38
         compiled from javascript/news.detailslogin.js.tpl */ ?>
<?php echo '
...
'<?php echo ';
		...
		function send_comment()
		{
			...
			if((comment == "") || (comment == undefined))
			{
				...
				$("#nohtmlcontent").attr("innerHTML","';  echo $this->_config[0]['vars']['pleasefillcomment'];  echo '");
		...
		function report_newsCallback(val)
		{
			// do the actions
			var reported = '; ?>
'<?php echo $this->_config[0]['vars']['reported']; ?>
'<?php echo ';
