<?php /* Smarty version 2.6.9, created on 2009-06-20 19:03:06
         compiled from javascript/newsdashboard.login.js.tpl */ ?>
<?php echo '
	<!-- call the source -->
	...
	<script type="text/javascript"> 
		...
		{
			// confirm
			if(confirm(\'';  echo $this->_config[0]['vars']['deletenewsconfirmation'];  echo '\')) 
			{
				// hide the news
				deletedid = newsid;
		...
		function delete_newsCallback(val)
		{
			if(val == 1) {
				...
				alert(\'';  echo $this->_config[0]['vars']['pleasetryagain'];  echo '\');
			}
		}
	</script>
'; ?>