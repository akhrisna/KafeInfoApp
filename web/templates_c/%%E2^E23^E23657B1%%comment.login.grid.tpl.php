<?php /* Smarty version 2.6.9, created on 2009-06-21 00:36:17
         compiled from datagrid/comment.login.grid.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'datagrid/comment.login.grid.tpl', 5, false),)), $this); ?>
...
'">
			...
			<div class="comment_header_action">
				<a href="javascript:delete_comment('<?php echo $this->_tpl_vars['comments'][$this->_sections['mysec']['index']]['id']; ?>
');" title='<?php echo $this->_config[0]['vars']['deletecomment']; ?>
'><img src='images/ic_delete.png' alt='<?php echo $this->_config[0]['vars']['deletecomment']; ?>
' class="action_icon"/></a>
			</div>
		</div>
	</div>
