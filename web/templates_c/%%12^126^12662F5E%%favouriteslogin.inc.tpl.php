<?php /* Smarty version 2.6.9, created on 2009-06-20 18:48:40
         compiled from includes/favouriteslogin.inc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'includes/favouriteslogin.inc.tpl', 20, false),)), $this); ?>
<!-- the header -->
...
'">
				...
				<div class="comment_header_action">
					<a href="javascript:delete_favourite('<?php echo $this->_tpl_vars['favourites'][$this->_sections['mysec']['index']]['id']; ?>
');" title='<?php echo $this->_config[0]['vars']['deletefavorite']; ?>
