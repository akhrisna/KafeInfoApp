<?php /* Smarty version 2.6.9, created on 2009-06-20 19:54:18
         compiled from includes/news.inc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'includes/news.inc.tpl', 20, false),)), $this); ?>
<!-- the header -->
...
'">
					<?php echo ((is_array($_tmp=$this->_tpl_vars['news'][$this->_sections['mysec']['index']]['title'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 65) : smarty_modifier_truncate($_tmp, 65)); ?>
