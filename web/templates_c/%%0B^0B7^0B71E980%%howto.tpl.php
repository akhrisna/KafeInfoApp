<?php /* Smarty version 2.6.9, created on 2009-06-21 11:53:33
         compiled from static/howto.tpl */ ?>
	...
	<div class="howto_padding">
		...
		<div class="howto_navigation">
			<ul id="buttons" class="howto_navigaton_list">
				<li><a href="javascript:void(null);"><?php echo $this->_config[0]['vars']['createaccount']; ?>
</a></li>
				<li><a href="javascript:void(null);"><?php echo $this->_config[0]['vars']['sendnews']; ?>
</a></li>
				<li><a href="javascript:void(null);"><?php echo $this->_config[0]['vars']['votenews']; ?>
</a></li>
			</ul>
