...
/*
nusoap.php,v 1.3.16.1 2007-05-22 09:29:10 khris Exp
...
* @version  nusoap.php,v 1.3.16.1 2007-05-22 09:29:10 khris Exp
* @access   public
*/
class nusoap_base {
		...
		if (count($this->bindings) >= 1) {
			...
			foreach($this->bindings as $bindingName => $attrs) {
				...
				foreach($attrs['operations'] as $opName => $opParts) {
					...
					// Added by Edwin Martin 2004-11-06
					$binding_xml .= '<fault name="WebServiceExceptionsType"><soap:fault encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" name="WebServiceExceptionsType" namespace="http://streamedit.com/MMCS" use="encoded"/></fault>';
					...
					// Added by Edwin Martin 2004-11-06
					$portType_xml .= '<fault message="tns:phpSoapFaultResponse" name="WebServiceExceptionsType"/>';
